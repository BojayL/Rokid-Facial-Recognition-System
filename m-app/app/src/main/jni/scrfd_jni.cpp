// SCRFD Face Detection JNI Interface
// Simplified version for static image detection (no camera support)
...
Java_com_sustech_bojayL_ml_InsightfaceNcnnDetector_nativeInit(
    JNIEnv* env,
    jobject thiz,
 ...
 * @return float array: [numFaces, face1_x, face1_y, face1_w, face1_h, face1_prob, ...]
 *         Returns null if detection fails
 */
JNIEXPORT jfloatArray JNICALL
Java_com_sustech_bojayL_ml_InsightfaceNcnnDetector_nativeDetect(
    JNIEnv* env,
    jobject thiz,
    jobject bitmap,
    ...
    // Build result array
    // Format: [numFaces, x1, y1, w1, h1, prob1, lm1_x1, lm1_y1, ..., lm1_x5, lm1_y5, x2, y2, w2, h2, prob2, lm2_x1, ...]
...
Java_com_sustech_bojayL_ml_InsightfaceNcnnDetector_nativeRelease(
    JNIEnv* env,
    jobject thiz
) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_sustech_bojayL_ml_InsightfaceNcnnDetector_nativeIsInitialized(
    JNIEnv* env,
    jobject thiz
) {
