...
Java_com_sustech_bojayL_glasses_ml_NcnnMobileFaceRecognizer_nativeInit(
    JNIEnv* env,
    jobject thiz,
...
Java_com_sustech_bojayL_glasses_ml_NcnnMobileFaceRecognizer_nativeExtractFeature(
    JNIEnv* env,
    jobject thiz,
    jobject faceBitmap
) {
...
Java_com_sustech_bojayL_glasses_ml_NcnnMobileFaceRecognizer_nativeCosineSimilarity(
    JNIEnv* env,
    jobject thiz,
...
Java_com_sustech_bojayL_glasses_ml_NcnnMobileFaceRecognizer_nativeRelease(
    JNIEnv* env,
    jobject thiz
) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_sustech_bojayL_glasses_ml_NcnnMobileFaceRecognizer_nativeIsInitialized(
    JNIEnv* env,
    jobject thiz
) {
